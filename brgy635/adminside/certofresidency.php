...
$sql = "SELECT req_name_residency, postal_address_residency, purpose_residency FROM certificate_of_residency WHERE resident_id = ?";
...
<body>
    <div class="mainHolder">
        ...
        <div class="container">
            ...
            <p id="certify">This is to certify that the person (the requestor), whose information is indicated below, is known to me as a bona fide resident of this barangay.</p>

            <div class="vitalinfo">
                <p id="name"><span>Requestor\'s Name:</span><u>' .'&nbsp;&nbsp; ' . $certificate_result['req_name_residency'] . '&nbsp;&nbsp;</u></p>
                <p id="postalAdd"><span>Postal Address:</span> <u>' .'&nbsp;&nbsp; ' . $certificate_result['postal_address_residency'] . '&nbsp;&nbsp;</u></p>
            </div>
            ...
            <div class="vitalinfo">
                <p id="purpose"><span>Purpose:</span> <u>' .'&nbsp;&nbsp; ' . $certificate_result['purpose_residency'] . '&nbsp;&nbsp;&nbsp;&nbsp;</u></p>
            </div>

            <div class="note">
                <p>This certificate is issued on <b>' . date("F j, Y") . '</b> at Barangay 635, Zone 64, District VI, City of Manila, Philippines.</p>
            <p>Moreover, this certificate is<b> VALID</b> only for <b> 6 months from the date of issue.</b></p>
            </div>
