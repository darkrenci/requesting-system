            ...
            <div id="dashboard" class="content-section active">
                ...
                <div class="box-container">
                    <div class="box one" id="numUsers">
                        <i class="bi bi-people-fill"></i></i> Users: 0
                    </div>
                    <div class="box two" id="numBarangayClearance">
                        <i class="fas fa-file-alt"></i> Barangay Clearance Requests: 0
                    </div>
                    <div class="box three" id="numBusinessClearance">
                        <i class="fas fa-building"></i> Business Clearance Requests: 0
                    </div>
                    <div class="box four" id="numIndigency">
                        <i class="fas fa-id-card"></i> Certificate of Indigency Requests: 0
                    </div>
                    <div class="box five" id="numResidency">
                        <i class="fas fa-home"></i> Certificate of Residency Requests: 0
                    </div>
                    <div class="box six" id="numMaleUsers">
                        <i class="fas fa-male"></i> Male Users: 0
                    </div>
                    <div class="box seven" id="numFemaleUsers">
                        <i class="fas fa-female"></i> Female Users: 0
                    </div>
                </div>
